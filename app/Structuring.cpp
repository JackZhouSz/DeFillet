...
typedef CGAL::Shape_detection::Efficient_RANSAC_traits<Kernel, Pwn_vector, CGAL::First_of_pair_property_map<Point_with_normal>, CGAL::Second_of_pair_property_map<Point_with_normal>> Traits;
...
int main (int argc, char* argv[])
{
  ...
  const std::string fname = CGAL::data_file_path("../test.ply");
